  ...
  return (
    <Flex direction={'column'} wrap="nowrap" gap={"xl"}>
      ...
      <Group position="apart" mt="md" mb="xs">
        <Text weight={500} ml={10}>Harold Ye</Text>
    ...
    <Card withBorder shadow="sm" radius="md">
      ...
      <Group style={{"alignItems": "start"}}>
        <Avatar mt={10} src="https://www.dogbreedinfo.com/images32/GermanShepherdAdultDogLayInGrassOutside.jpg" radius="xl" />
        ...
        <div style={{ flex: 1 }}>
          ...
          <Text color="dimmed" size="xs">
            Sunny is the first dog I adopted, he likes to play in grasslands, he is always energetic when going out.
          </Text>
        </div>
    ...
    <Card withBorder shadow="sm" radius="md">
      ...
      <Group style={{"alignItems": "start"}}>
        ...
        <div style={{ flex: 1 }}>
          ...
          <Text color="dimmed" size="xs">
            Harold found a disabled Russian Blue Cat at <a href="">Madison, Wisconsin</a>. This cat has been sent to the <a href="">CBR Animal Organization</a>!
      ...
      <Group style={{"alignItems": "start"}}>
        ...
        <div style={{ flex: 1 }}>
          ...
          <Text color="dimmed" size="xs">
            Harold adopted Luoluo from <a href="">CBR Animal Organization</a>!
          </Text>
        </div>
